...
Current state: 569 tests green under `-race`, plus 20 live tests against the real endpoint.
Coverage 89.9% overall, 97.4% on `plan.go`, 96.7% on `envelope.go` (CI floors: 80/95/95). All 20 MCP tools reachable.
